...
var tlsOptions = {
    ...
    cert: fs.readFileSync('certs/wss-cert.pem')
};
...
exports.listenTls = function(port, host, connectionHandler) {
  var srv = https.createServer(tlsOptions, function(req, res) {
  });

  srv.on('upgrade', function(req, socket, upgradeHead) {
    var wss = new WebSocketConnection(req, socket, upgradeHead);
